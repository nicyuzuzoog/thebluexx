  ...
  return (
    <footer className="footer">
      ...
      <style>{`
        ...
        .footer-about { font-size: 0.85rem; line-height: 1.7; color: rgba(255,255,255,0.52); }
        .footer-heading {
          font-family: var(--font-display);
        ...
        .footer-links a:hover { color: var(--jade-light); transform: translateX(4px); }
        .contact-team { display: flex; flex-direction: column; gap: 10px; }
        .contact-card {
        ...
        .contact-phone:hover { color: var(--white); background: rgba(255,255,255,0.1); }
        .contact-wa {
          color: #25D366;
        ...
        .contact-wa:hover { background: rgba(37,211,102,0.2); transform: scale(1.1); }
        .footer-contact { display: flex; flex-direction: column; gap: 5px; }
        .footer-contact p {
          display: flex; align-items: center; gap: 7px;
          font-size: 0.78rem; color: rgba(255,255,255,0.42);
        }
        .footer-email-link { color: rgba(255,255,255,0.42); transition: color var(--dur-fast); }
        .footer-email-link:hover { color: var(--jade-light); }
        .footer-newsletter-text { font-size: 0.82rem; color: rgba(255,255,255,0.52); margin-bottom: 12px; }
        .footer-subscribe-form {
          display: flex; border-radius: var(--r-full); overflow: hidden;
        ...
        .footer-subscribe-input {
          ...
          font-size: 0.85rem; font-family: var(--font-body); border: none;
        }
        ...
        .footer-bottom {
          background: rgba(0,0,0,0.28); padding: 12px 0;
        ...
        .dev-link { color: var(--jade-light); font-weight: 600; transition: color var(--dur-fast); }
